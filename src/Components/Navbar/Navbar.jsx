...
const Navbar = () => {
  ...
  const menus = [
    <li key={1}>
      <NavLink to={"/"} className={"font-semibold uppercase"}>Home</NavLink>
    </li>,
    <li key={2}>
      <NavLink to={"/cars"} className={"font-semibold uppercase"}>Cars</NavLink>
    </li>,
    <li key={3}>
      <NavLink to={"/bikes"} className={"font-semibold uppercase"}>Bikes</NavLink>
    </li>,
  ];
  return (
    <>
